...
router.post('/save', async (req, res) => {
    console.log('********** BR Journey Builder Save **********');
...
router.post('/validate', async (req, res) => {
    console.log('********** BR Journey Builder Validate **********');
...
router.post('/publish', async (req, res) => {
    console.log('********** BR Journey Builder Publish **********');
